...
export default function FavoritesButton({ recipe, className }: favoritesProps) {
  ...
  return (
    <div className={isLoading ? "opacity-50 pointer-events-none" : ""}>
      <button
        onClick={toggleLike}
        type="button"
        className="cursor-pointer transition-transform bg-dark-primary/50 p-1 rounded-xl"
      >
        <svg
