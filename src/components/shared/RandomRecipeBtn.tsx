...
export default function RandomRecipeBtn() {
	...
	return (
		<button
			className="btn btn-xl btn-block border-none text-xl bg-linear-to-r from-emerald-400 to-cyan-400 rounded-xl shadow-md sm:max-w-4xl sm:flex sm:items-center"
