...
export const EnergyQuestion = ({
  ...
  // Question
  <div className="flex flex-col gap-6 text-light-primary">
    <h1 className=" text-4xl">What's your energy level?</h1>
...
export const CravingQuestion = ({
  ...
  <div className="text-light-primary/90">
    {/* Question */}
    <h1 className="col-span-1 text-4xl pt-4 pb-12">What are you craving?</h1>

    {/* Answers */}
    <div className="w-full grid grid-cols-1 gap-6">
      <button
        onClick={() => onAnswer("hearty")}
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-primary-btn"
      >
        <svg
      ...
      <button
        ...
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-green-gradient"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="35"
      ...
      <button
        ...
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-red-gradient"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="35"
      ...
      <button
        ...
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-lightBlue-gradient"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="35"
...
export const DishPreference = ({
  ...
  <div className="text-light-primary/90">
    {/* Question */}
    <h1 className="col-span-1 text-4xl pt-8 pb-8">
    ...
    <div className="w-full grid grid-cols-1 gap-4">
      ...
      <button
        ...
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-pink-gradient"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="30"
      ...
      <button
        ...
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-orange-gradient"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="30"
      ...
      <button
        ...
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-blue-gradient"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="30"
...
export const DietPreference = ({
  ...
  <div className="text-light-primary/90">
    {/* Question */}
    <h1 className="col-span-1 text-4xl pt-10 pb-12">
    ...
    <div className="w-full grid grid-cols-1 gap-4">
      ...
      <button
        ...
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-darkGreen-gradient"
      >
        <span className="text-xl font-semibold">Vegan</span>
      </button>
      <button
        onClick={() => onAnswer("glutenFree")}
        className="flex items-center justify-around p-4 rounded-xl shadow-md/20 bg-yellow-gradient"
      >
