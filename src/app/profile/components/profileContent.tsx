...
export default function ProfileContent({ currentUser }: any) {
	...
	return (
		<section className="flex flex-col items-center mb-20">
			<h2 className="text-4xl font-bold pb-8 pt-10 text-center md:pt-28">
				Welcome back!
			</h2>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
									{favorites.map((fav) => (
										<Link
											...
											className="group bg-light-primary/80 rounded-2xl overflow-hidden border border-light-primary/10 transition-all shadow-lg"
										>
