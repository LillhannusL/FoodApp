...
export default function Home() {
  return (
    <main className="w-full min-h-screen p-4 flex flex-col items-center">
      <h1 className="md:pt-20 md:hidden">CulinaryQuest</h1>
      <h2 className="hidden md:block text-3xl font-semibold pt-28 pb-8">
